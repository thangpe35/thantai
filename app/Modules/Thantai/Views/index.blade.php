                ...
                <div class="d-flex col-lg-8 mobile-col">
                    ...
                    <div class=" col-lg-6">
                        ...
                        <form action="{{url('thantai')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-4 d-flex justify-content-center" style="font-family:SVN Gotham ;color: white; font-size:3vh">Thời gian giao hàng </div>
                            <div class="mb-4 d-flex justify-content-center">
                                <input type="date" class="col-form-label " style="width: 300px;" id="date" name="date" value="<?php echo date('Y-m-d'); ?>">
                            </div>
                            <div class="mb-4 d-flex justify-content-center">
