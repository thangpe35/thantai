            ...
            <div class="d-flex mt-5">
                <div class="col-sm-7">
                    <div class="text-center">
                        <img src=" {{ asset('img/abcd.png') }} " alt="" style="width: 150px; height: 192px;">
                    </div>
                ...
                <div class="col-sm-5">
                    ...
                    <form action="{{url('')}}" method="post">
                            ...
                            <div class="d-flex flex-row justify-content-center ">
                                <div class="d-flex flex-row">
                                    <div class="element p-2 bd-highlight">
                                        <img src="{{asset('img/thantai.jpg')}}" class="img-fluid ">
                                        <p>10 Chỉ nhẫn ép tròn</p>
                                        <div class="d-flex justify-content-center">
                                            <div class="buttons_added">
                                                ...
                                                <input class="plus is-form increment-btn" type="button" value="+" onclick="incre()">
                                            </div>
                                        </div>
                        ...
                        <div class="mb-4 d-flex justify-content-center">
                            <input type="date" class="col-form-label " style="width: 300px;" id="date" name="date">
                        </div>
                        <div class="mb-4 d-flex justify-content-center">
...
<script type="text/javascript">
    ...
    function incre() {
        ...
        var inc_value = document.getElementById('textbox');
        ...
        if (value < 10) {
            value ++;
            document.querySelectorAll('input-qty').values(value)
        }
